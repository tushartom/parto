  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 space-y-12">
        ...
        <section className="">
          <h3 className="text-[22px] border-b border-slate-200 pb-4   font-bold italic  leading-7 text-slate-900">
            Verified {make} <span className="text-blue-600">Specialists</span>
          </h3>

          <p className="text-[12px] font-semibold  text-slate-400 mt-4 mb-6 tracking-wide">
            &#183; Found {suppliers.length} active suppliers handling your
            vehicle brand
          </p>
    ...
    <div className="group bg-white border-2 border-slate-100 rounded-[2.5rem] p-8 flex flex-col transition-all duration-300 hover:border-blue-600 hover:shadow-2xl hover:shadow-blue-50">
      <div className="flex items-start gap-5 mb-8">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-1.5 text-slate-500">
            ...
            <span className="text-[12px] font-semibold tracking-wide truncate">
      ...
      <div className="mt-auto border-t border-slate-50">
        <a
          ...
          target="_blank"
          className="w-full py-5 bg-white border-2 border-slate-900 rounded-2xl flex items-center justify-center gap-3 font-black italic uppercase text-xs tracking-wide transition-all shadow-[6px_6px_0px_0px_rgba(37,99,235,1)] hover:bg-slate-900 hover:text-white hover:shadow-none active:translate-y-1 active:shadow-none"
        >
